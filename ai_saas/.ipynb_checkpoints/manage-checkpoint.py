...
@app.route('/doc/tree/hy-tmp/chapter-456/ai_saas', methods=["POST"])
def ai_saas():
...
# curl -H "Content-Type: application/json" --data @body.json http://localhost:9000/doc/tree/hy-tmp/chapter-456/ai_saas

# http://i-1.gpushare.com:15590/doc/tree/hy-tmp/chapter-456/ai_saas/body.json